...
$sql = "SELECT * FROM notaempenho WHERE id_ne={$_GET[alterar]}";
//executa a query
...
<tr>
    ...
    <form action="grava_cad_ne.php" method="POST">
       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td><input type="text" name="data_rec_ne" size="8" maxlength="10" value="<?php echo $linha[data_rec_ne]; ?>">
                    <?php 
                        //if ($erro_data_rec_ne){
            ...
            <tr>
                ...
                <td><input type="text" name="prazo_ent_ne" size="3" maxlength="3" value="<?php echo $linha[prazo_ent_ne]; ?>">
                    <?php
               ...
               <tr>
                ...
                <td><input type="text" name="data_proposta" size="8" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $linha[data_proposta]; ?>">
                    <?php 
            ...
            <tr>
                ...
                <td><input type="text" name="val_proposta" size="3" maxlength="3" value="<?php echo $linha[val_proposta]; ?>">
                    <?php
            ...
            <td width="140" align="right">Número da Nota de Empenho:</td>
                <td><input type="text" name="num_ne" size="20" maxlength="50" value="<?php echo $linha[num_ne]; ?>">
                    <?php
                        //if($erro_num_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <td><input type="text" name="data_prev_pgto" size="3" maxlength="3" value="<?php echo $linha[data_prev_pgto]; ?>">
                    <?php
                        //if($erro_num_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <tr>
                    ...
                    <td align="left">
                        <select name="status_ne" size="0" >
                            <option><?php echo $linha[status_ne]; ?></option>
            ...
            <tr>
                ...
                <td><input type="hidden" name="id_ne" value="<?php echo $linha[id_ne]; ?>">
                </td>
