...
<table align="center" class="A" width="1020" border="1" cellpadding="3" cellspacing="0">
...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_itens_ne.php?id_ne=$_GET[id_ne]";
                            else echo "grava_itens_ne.php"; ?>" method="POST" name="cad_itens_ne">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td class="" align="right">V. Frete: R$</td>
            ...
            -->
            <td class="" align="right">V. Item NE: R$</td>
                <td><input type="text" class="" name="vitem" size="10" maxlength="10" value="<?php echo $_POST[vitem]; ?>">
                    <?php
                        //if($erro_vofertado){
                         //   echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <!--<td class="credito and green" align="right">V. Total Item: R$</td>
                <td colspan="2"><input type="text" name="vofertado" size="25" maxlength="10" value="<?php echo $_POST[vofertado]; ?>">
                    <?php
                        //if($erro_vofertado){
                         //   echo "<font color=red>*** Campo obrigatório</font>";
                        //}
           ...
           <tr>
            ...
            <?php
                ...
                if(!$erro and !empty($_POST)){
                  echo '<script language="javascript">document.cad_itens_ne.submit()</script>';
                }
            ?>
...
<?php
    ...
    //require "cad_itens_ne_baixa.php";
