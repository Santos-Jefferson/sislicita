...
$sql = "SELECT * FROM precadastro WHERE codigo LIKE '%{$_GET[codigo]}%' ORDER BY {$_GET[order]} DESC";
...
<table width="1010" align="center" class="A" border="1" cellpadding="3" cellspacing="0">
        <tr>
            <!--<th>Cod_int</th>-->
...
?>
    ...
    <tr>
        ...
        <td align="center">
            ...
            echo "<a href='altera_precad.php?alterar=$linha[id]'><img src='imagens/edit.png' border='0'/></a>";
            echo "<a href='conf_precad_exc.php?apagar=$linha[id]'><img src='imagens/delete.png' border='0'/></a>";
            }
