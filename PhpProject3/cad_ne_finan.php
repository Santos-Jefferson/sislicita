...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_ne_finan.php";
                            else echo "grava_cad_ne_finan.php"; ?>" method="POST" name="cad_ne_finan">
       ...
       <table width="" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td><input type="text" name="data_pgto" size="10" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $_POST[data_pgto]; ?>">
                    <?php 
                        if ($erro_data_exp){
            ...
            <tr>
                ...
                <td>
                    <textarea name="historico_obs_finan" rows="10" cols="40">
                        <?php
                        ...
                        if (!empty($_POST[historico_obs_finan])){
                            echo $_POST[historico_obs_finan]." ### ";
