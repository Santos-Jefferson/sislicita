...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_fornecedor.php";
                            else echo "grava_cad_forn.php"; ?>" method="POST" name="cad_fornecedor">
       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            <tr>
                <td colspan="2" align="center"><strong>CADASTRO FORNECEDORES<hr></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="nome_forn" size="50" maxlength="50" value="<?php echo $_POST[nome_forn]; ?>">
                    <?php
                        if($erro_nome_forn){
            ...
            <tr>
                ...
                <td><input type="text" name="website_forn" size="50" maxlength="500" value="<?php echo $_POST[website_forn]; ?>">
                    <?php
            ...
            <tr>
                ...
                <td><input type="text" name="usuario_forn" size="50" maxlength="100" value="<?php echo $_POST[usuario_forn]; ?>">
                    <?php
            ...
            <tr>
                ...
                <td><input type="text" name="contato_forn" size="50" maxlength="50" value="<?php echo $_POST[contato_forn]; ?>">
                    <?php
            ...
            <tr>
                ...
                <td><input type="text" name="msn_forn" size="50" maxlength="50" value="<?php echo $_POST[msn_forn]; ?>">
                    <?php
                        //if($erro_msn_forn){
                            //echo "<font color=red>*** Campo obrigatório</font>";
                        //}
            ...
            <tr>
                ...
                <td><input type="text" name="fone_forn" size="50" maxlength="50" onKeyDown="Mascara(this,Telefone);" onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" value="<?php echo $_POST[fone_forn]; ?>">
                    <?php
                        if($erro_fone_forn){
                            echo "<font color=red>*** Campo obrigatório</font>";
                        }
