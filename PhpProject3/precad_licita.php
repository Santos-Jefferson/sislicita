...
//echo $H;
    if ($H<"07:30"){
        //echo "teste";
        echo "<table align='center' width='1010' border='1' class='' cellpading='0' cellspacing='0' >
            <tr>
                <td colspan='2' align='center'><strong><p><h2><font color='red'>HORÁRIO PERMITIDO PARA PRÉ-CADASTRO APARTIR DAS 07:30hs!</p></td>
            </tr>
    </table>";
        exit;
    }
       ...
       <table align="center" border="1" width="1020" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td><input type="text" name="codigo" size="16" maxlength="100" value="<?php echo $_POST[codigo]; ?>">
                <?php
                        if($erro_codigo){
                            echo "<font color=red>*** Campo obrigatório</font>";
                        }
            ...
            <tr>
                ...
                <td><select name="status" size="0">
                        <option><?php echo "Aguardando pregao"; ?></option>
