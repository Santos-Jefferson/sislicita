       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td><input type="text" name="linha_adic_1" size="100" maxlength="5000" value="<?php echo $_POST[linha_adic_1]; ?>">
                </td>
            </tr>
            <tr>
                <td width="" align="right">Linha adicional 2:</td>
                <td><input type="text" name="linha_adic_2" size="100" maxlength="5000" value="<?php echo $_POST[linha_adic_2]; ?>">
                </td>
            </tr>
            
            <!--<tr>
                <td align="right">Data Proposta:</td>
                <td><input type="text" name="data_prop" size="8" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $_POST[data_prop]; ?>">
                </td>
            </tr>-->
            <!--<tr>
