       ...
       <table width="" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td><input type="text" name="num_nfe" size="10" maxlength="100" value="<?php echo $_POST[num_nfe]; ?>">
                    <?php
            ...
            <tr>
                ...
                <td><input type="text" name="qtde_vol" size="10" maxlength="10" value="<?php echo $_POST[qtde_vol]; ?>">
                    <?php
                        //if($erro_prazo_ent_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
            ...
            <tr>
                ...
                <td><input type="text" name="peso_kg" size="10" maxlength="10" value="<?php echo $_POST[peso_kg]; ?>">
                    <?php
                        //if($erro_prazo_ent_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <td>
                    <select id="nome_trans" name="transportadora_exp">
                        <?php
                            ...
                            echo "<option>$_POST[transportadora_exp]</option>";
            ...
            <tr>
                ...
                <td><input type="text" name="vfrete_exp" size="10" maxlength="10" value="<?php echo $_POST[vfrete_exp]; ?>">
                    <?php
                        //if($erro_prazo_ent_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
            ...
            <tr>
                ...
                <td><input type="text" name="prev_entrega_exp" size="10" maxlength="10" value="<?php echo $_POST[prev_entrega_exp]; ?>">
                    <?php
                        //if($erro_prazo_ent_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
               ...
               <tr>
                ...
                <td><input type="text" name="data_exp" size="10" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $_POST[data_exp]; ?>">
                    <?php 
                        if ($erro_data_exp){
