...
<tr class="">
    <td colspan="10" bgcolor="lightyellow">
    <center><h2><font color="">LICITAÇÕES A PARTICIPAR - <?php echo (date('d/m/Y'));?>
    </td>
</tr>
<tr class="">
    <td colspan="10">
...
while($linha){
    ...
    ?>
     ...
     <tr>
        ...
        <td>&nbsp;<?php echo date('H:i',strtotime($linha[hora]));                               ?></td>
...
?>
    <tr>
        <td colspan="10">Total de registros: <?php echo $c ?></td><br>
    </tr>
    </table>
    <?php
