...
$sql2 = "SELECT * FROM subitens WHERE id_subitem={$_REQUEST[alterar]}";
//executa a query
...
document.getElementById("res_vtotcusto_si").value = res_qtde_si * res_vunitcusto_si;
    ...
    <form action="grava_itens_det.php" method="POST">
    <!--<form action="<?php //if ($erro or empty($_POST)) echo "altera_subitens.php?id_item=$_GET[id_item]&alterar=$_GET[id_item]";
        ...
        <table align="center" width="1000" border="1" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td width=""><input type="text" name="sub_itens" size="10" maxlength="50" value="<?php echo $linha[sub_itens]; ?>">
                    <?php
                        //if($erro_sub_itens){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <td width=""><input type="text" name="modelo_si" size="50" maxlength="5000" value="<?php echo $linha[modelo_si]; ?>">
                <?php
                        //if($erro_modelo_si){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <td width=""><input type="text" class="forms"name="vtotcusto_si" size="10" maxlength="10" id="res_vtotcusto_si" value="<?php echo $linha[vtotcusto_si]; ?>"></td>
                <td width=""><input type="text" name="obs_si" size="20" maxlength="100" value="<?php echo $linha[obs_si]; ?>"></td>                        
                
                <td align="left">
                    <select name="ro_subitem" size="0" >
                        <option><?php echo $linha[ro_subitem]; ?></option>
                        <option>Sim</option>
                        <option>Não</option>
                    </select>
            </tr>
