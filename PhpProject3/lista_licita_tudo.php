...
//if($usuario == "admin"){
    ...
    $sql = "SELECT * FROM codigo WHERE tipo_licitacao LIKE '%{$_GET[codigo]}%' or codigo LIKE '%{$_GET[codigo]}%' or pregao LIKE '%{$_GET[codigo]}%' or orgao LIKE '%{$_GET[codigo]}%' or licitante LIKE '%{$_GET[codigo]}%' or local_licitacao LIKE '%{$_GET[codigo]}%' ORDER BY {$_GET[order]} DESC, {$_GET[order2]} ASC";
    //}
    //else{
     ...
     <tr>
        ...
        <td align="center">
            ...
            if (($linha[licitante]) == ($usuario)){
                ...
                echo "<a href='ro_positivo.php?id_cod=$linha[id_cod]'><img src='imagens/logo_positivo.png' border='0'/></a>";
                echo "<a href='ro_lenovo.php?id_cod=$linha[id_cod]'><img src='imagens/logo_lenovo.png' border='0'/></a>";
            }
            
            elseif (($usuario == "admin") or ($usuario == "vinicius")){
                echo "<a href='altera_licita.php?alterar=$linha[id_cod]'><img src='imagens/edit.png' border='0'/></a>";
                echo "<a href='conf_licita_exc.php?apagar=$linha[id_cod]&codigo=$linha[codigo]'><img src='imagens/delete.png' border='0'/></a>";
                echo "<a href='ro_positivo.php?id_cod=$linha[id_cod]'><img src='imagens/logo_positivo.png' border='0'/></a>";
                echo "<a href='ro_lenovo.php?id_cod=$linha[id_cod]'><img src='imagens/logo_lenovo.png' border='0'/></a>";
