...
?>
   ...
   <tr>
        <td colspan="2" align="left" bgcolor="red" class="A" scope="col">
            Remover a ASSISTÊNCIA <?php echo $_GET[nome_assist]; ?>?
            <input type='button' value='SIM'
               onclick='document.location.href="apaga_assist.php?apagar=<?php echo $_GET[apagar]; ?>"'>
            <input type='button' value='NÃO'
               onclick='document.location.href="lista_cad_assistencias_tudo.php"'>
        </td>
