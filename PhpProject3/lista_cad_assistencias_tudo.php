...
if(empty($_GET[order])) $_GET[order] = 'nome_assist';
//if(empty($_GET[order2])) $_GET[order2] = 'hora';

//if($usuario == "admin"){

    $sql = "SELECT * FROM cad_assistencias ORDER BY {$_GET[order]} ASC";
    //}
    //else{
...
<!--<table width="1020" align="center" class="A" border="1" cellpadding="2" cellspacing="0">-->
    <tr class="forms">
            ...
            <th colspan="10" align="center">ASSISTÊNCIAS PARCEIRAS - SANTOS & MAYER</th>
        </tr>
    <tr>
        <td colspan="10">
            <input type='button' value='Cadastrar Nova Assistência' class='botao'
               onclick='document.location.href="cad_assistencias.php?usuario=<?php echo "$user_logged"; ?>"'>
            <!--
        ...
        <tr class="">
            <!--<th>Cod_int</th>-->
            <td align="center"><a href="lista_cad_assistencias_tudo.php?order=razao_social">RAZÃO SOCIAL<img src="imagens/seta1.jpg"></a></td>
            <th align="center"><a href="lista_cad_assistencias_tudo.php?order=nome_assist">NOME FANT.<img src="imagens/seta1.jpg"></a></th>
            <th align="center">CONTATO</th>
            <th align="center">EMAIL</th>
            <th align="center">FONES</th>
            <!--<th align="center">FONE 2</th>
            <th align="center">FONE 3</th>-->
            <th align="center"><a href="lista_cad_assistencias_tudo.php?order=cidade">CIDADE ATENDIDA<img src="imagens/seta1.jpg"></a></th>
            <th align="center"><a href="lista_cad_assistencias_tudo.php?order=estado">UF<img src="imagens/seta1.jpg"></a></th>
            <th align="center">AUT. POSITIVO?</th>
            <th>AÇÃO</th>
        </tr>
<?php
...
while($linha){
    ...
    ?>
     ...
     <tr>
        ...
        <td align="center" width="">&nbsp;<a href="javascript:abrir('info_assist.php?cnpj=<?php echo $linha[cnpj];?>');"><?php echo $linha[razao_social]                          ?></a></td>
        <td align="center" width="">&nbsp;<?php echo $linha[nome_assist]                          ?></a></td>
        <td align="center">&nbsp;<?php echo $linha[contato_assist]                          ?></td>
        <td align="center">&nbsp;<a href="mailto:<?php echo $linha[email_assist];?>?subject=Assistência Técnica"><?php echo $linha[email_assist]                          ?></a></td>
        <td width ="100" align="center"><?php echo "$linha[fone_assist]\n$linha[fone_assist2]\n$linha[fone_assist3]";?></td>
        <!--<td align="center">&nbsp;<?php echo $linha[fone_assist2]                          ?>
        
        </td>
        <td align="center">&nbsp;<?php echo $linha[fone_assist3]                          ?>-->
        <td align="center" width="">&nbsp;<?php echo $linha[cidade]                          ?></td>
        <td align="center" width="">&nbsp;<?php echo $linha[estado]                          ?></td>
        <td align="center">&nbsp;<?php echo $linha[aut_positivo]                          ?></td>
