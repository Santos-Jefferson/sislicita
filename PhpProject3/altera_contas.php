...
$sql2 = "SELECT * FROM contas_pagar_receber WHERE id_contas={$_GET[alterar]}";
//executa a query
$res2 = mysql_query($sql2) or die("Erro selecionando (altera_contas.php)");
...
<tr>
    ...
    <form action="grava_cad_contas_pagar_receber.php" method="POST" name="altera_contas">
       ...
       <table width="1010" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td width="" colspan="" align="right">Descritivo/Histórico:</td>
                ...
                <td colspan=""><input type="text" name="valor_contas" size="7" maxlength="100" onKeyPress="return(MascaraMoeda(this,'.',',',event))" value="<?php if ($linha){
                                echo str_replace('.',',',$linha[valor_contas]);
                        
                                }
                                    else{
                                        $linha2[valor_contas]=abs($linha2[valor_contas]);//transforma o valor de negativo para absoluto (sem o - na frente)
                                        echo number_format($linha2[valor_contas],2,",",".");
                                    }
                             ?>">
                    <?php
            ...
            <tr>
                <td width="" align="right">Tipo Conta:</td>
               ...
               <td>
                    <select id="banco_contas" name="banco_contas">
                        <?php
                            ...
                            echo "<option>$linha2[banco_contas]</option>";
            ...
            <tr>
                        ...
                        <?php
                            ...
                            echo "<option>$linha[cl_forn_contas]</option>";
                                   ...
                                   $sql="SELECT nome_forn FROM cad_fornecedor ORDER BY nome_forn ASC";
                                    ...
                                    echo "<option>$linha2[cl_forn_contas]</option>";
                ...
                <input type="hidden" name="id_contas" size="3" maxlength="3" value="<?php echo $linha2[id_contas]?>">
            ...
            ?> 
                ...
                <td colspan="" align="center"><input type="submit" value="Alterar"  class='botao'/></td>
        ...
        <?php
               // include "lista_cad_contas_pagar_receber.php";
