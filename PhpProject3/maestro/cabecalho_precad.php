...
<tr>
    <td colspan="" align="center" class="A" scope="col">PRÉ-CADASTROS - LICITAÇÕES</td>
    <td><input type='button' value='Menu Principal'
    ...
    <tr>
        <th colspan="1" align="left" class="A" scope="col">
            ...
            <input type='button' value='Listar pré-licitações'
