        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td align="right">Descrição/Produto:<br>
                                    <a href="cad_itens_det.php?id_item=<?php echo $linha[id_itens] ?>&id_subitem=<?php echo $linha_subitens[id_subitem]; ?>" target="popupwindow" onclick='window.open("cad_itens_det.php", "popupwindow", "scrollbars=yes,width=1050,height=450");return true'>(Adicionar sub-itens)</a></td>
            ...
            <tr>
                ...
                <td><input type="text" name="vofertado" size="10" maxlength="10" id="res_vofertado" onblur="cal_vimposto() & cal_custo_aprox() & cal_vminofertar()"  value="<?php echo $linha[vofertado]; ?>">
                    <?php
                        //if($erro_vofertado){
                         //   echo "<font color=red>*** Campo obrigatório</font>";
                        //}
