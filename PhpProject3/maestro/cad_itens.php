...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_itens.php?id_cod=$_REQUEST[id_cod]&id_lote=$_REQUEST[id_lote]&lote=$_REQUEST[lote]&codigo=$_REQUEST[codigo]&licitante=$_REQUEST[licitante]&data=$_REQUEST[data]&hora=$_REQUEST[hora]&orgao=$_REQUEST[orgao]";
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                <td class="forms" colspan="0" bgcolor="LemonChiffon" align="center"><strong>CADASTRE AQUI OS ITENS PARA O LOTE ESCOLHIDO</td>
            </tr>
            
            <tr>
                <td align="right"><strong>CÓDIGO LICITAÇÃO:</td>
            ...
            <tr>
                ...
                <td><input type="text" name="porc_lucro" size="5" maxlength="5" id="res_porc_lucro" value="<?php echo $_POST[porc_lucro]; ?>">%
                    <?php
                        //if($erro_porc_lucro){
                         //   echo "<font color=red>*** Campo obrigatório</font>";
                        //}
            ...
            <tr>
                ...
                <td class="debito" align="right">V. Frete: R$</td>
                ...
                <td class="forms and debito" align="right">V. Imposto: R$</td>
                ...
                <td class="credito" align="right">V. Ofert/Ganho: R$</td>
                <td><input type="text" name="vofertado" size="10" maxlength="10" id="res_vofertado" onblur="cal_vimposto() & cal_custo_aprox() & cal_vminofertar()"  value="<?php echo $_POST[vofertado]; ?>">
                    <?php
                        //if($erro_vofertado){
                         //   echo "<font color=red>*** Campo obrigatório</font>";
                        //}
            ...
            <tr>
                ...
                <td class="forms" align="right">V. Min. Ofertar: R$</td>
                ...
                <td class="forms" align="right">V. Min. Item: R$</td>
               ...
               <td class="forms and credito" align="right">Lucro Liq.: R$</td>
                ...
                <td colspan="2" align="center"><input type="submit" value="Cadastrar Item" /></td>
