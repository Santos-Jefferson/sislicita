...
document.getElementById("res_vtotcusto_si").value = res_qtde_si * res_vunitcusto_si;
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_itens_det.php?id_item=$_GET[id_item]";
                            else echo "grava_itens_det.php"; ?>" method="POST" name="cad_itens_det">
                            
       
        <table align="center" width="1000" border="1" class="A" cellpading="0" cellspacing="0" >
            <tr class="debito">
                <td colspan="7" align="center"><strong>CADASTRE AQUI OS SUB-ITENS DO SEU ITEM<hr></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            ...
            <tr>
                ...
                <td width=""><input type="text" name="modelo_si" size="50" maxlength="100" value="<?php echo $_POST[modelo_si]; ?>">
                <?php
                        if($erro_modelo_si){
                            echo "<font color=red>*** Campo obrigatório</font>";
                        }
            ...
            <?php
                ...
                if(!$erro and !empty($_POST)){
                    echo '<script language="javascript">document.cad_itens_det.submit()</script>';
                }
            
            ?>
            <tr>
                <td colspan="7" align="right"><input type="submit" value="Cadastrar" /></td>
