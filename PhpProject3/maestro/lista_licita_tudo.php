    ...
    ?>
     ...
     <tr>
        ...
        <td><?php 
                ...
                while($linha_lote){
                    echo "<a href='cad_itens.php?id_cod=$linha[id_cod]&id_lote=$linha_lote[id_lote]&lote=$linha_lote[lote]&codigo=$linha[codigo]&licitante=$linha[licitante]&data=$linha[data]&hora=$linha[hora]&orgao=$linha[orgao]'>{$linha_lote[lote]}</a>    -     ";
