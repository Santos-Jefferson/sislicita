<tr>
        <td colspan="2" align="left" bgcolor="red" class="A" scope="col">
            Expedição desta nota de empenho já consta informações. Favor verificar!!!
            <input type='button' value='VOLTAR'
               onclick='document.location.href="cad_ne_exp.php?id_cod=<?php echo $_POST[id_cod] ?>&id_lote=<?php echo $_POST[id_lote]?>"'>
