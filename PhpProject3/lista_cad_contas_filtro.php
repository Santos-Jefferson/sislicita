...
require_once "menu_financeiro.php";
...
if(empty($_GET[order])) $_GET[order] = 'desc_contas';
//if(empty($_GET[order2])) $_GET[order2] = 'hora';

//if($usuario == "admin"){

    $sql = "SELECT * FROM contas_pagar_receber WHERE obs_contas='' and cat_contas = '{$_REQUEST[lista_tipo]}'ORDER BY {$_GET[order]} {$_GET[ascdesc]}";
    //}
    //else{
