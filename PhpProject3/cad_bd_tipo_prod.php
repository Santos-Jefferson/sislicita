...
//-------------CAMPO codigo-------------------------
    if (empty($_POST[nome_tipo_prod])){
        $erro = $erro_nome_tipo_prod = true;
        }
...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_bd_tipo_prod.php";
                            else echo "grava_bd_tipo_prod.php"; ?>" method="POST" name="cad_bd_tipo_prod">
       ...
       <table width="500" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="490" border="0" class="A" cellpading="0" cellspacing="0" >
            <tr>
                <td colspan="2" align="center"><strong>CADASTRO TIPOS PRODUTOS<hr></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            <tr>
                <td width="140" align="right">Nome do Tipo do Produto:</td>
                <td><input type="text" name="nome_tipo_prod" size="50" maxlength="50" value="<?php echo $_POST[nome_tipo_prod]; ?>">
                    <?php
                        if($erro_nome_tipo_prod){
            ...
            <?php
                ...
                if(!$erro and !empty($_POST)){
                    echo '<script language="javascript">document.cad_bd_tipo_prod.submit()</script>';
                }
