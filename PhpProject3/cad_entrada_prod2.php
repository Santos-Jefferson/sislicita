...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_entrada_prod2.php";
                            else echo "grava_cad_entrada_prod.php"; ?>" method="POST" name="cad_entrada_prod2">
       ...
       <table width="1010" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1000" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td colspan="4"><input type="text" name="num_doc" size="10" maxlength="100" value="<?php echo $_POST[num_doc]; ?>">
                    <?php
                        if($erro_cod_num_doc){
                            echo "<font color=red>*** Campo obrigatório</font>";
                        }
                 ...
                 <td colspan="2" align="right">Data:</td>
            ...
            <tr>
                ...
                <td><input type="hidden" name="id_itens_ne" value="<?php echo $_REQUEST[id_itens_ne]; ?>">
                </td>
                <td><input type="hidden" name="num_ne" value="<?php echo $_REQUEST[num_ne]; ?>">
                </td>
            ...
            <?php
                ...
                if(!$erro and !empty($_POST)){
                    echo '<script language="javascript">document.cad_entrada_prod2.submit()</script>';
                }
            
            ?> 
           

                <td colspan="" align=""><input type="submit" value="Cadastrar" /></td>
