...
<tr>
    ...
    <form action="gera_relatorio_cont.php" method="POST">
       ...
       <table width="1020" border="1" align="center" class="A" cellpadding="0" cellspacing="0">
          ...
          <table width="1010" border="0" align="center" class="A" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr>
                <td colspan="2" align="center"><strong>ESCOLHA O STATUS PARA GERAR O RELATÓRIO DE CONTRATOS<hr></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    <select name="status_ne" size="0" >
                        <option><?php echo $_POST[status_cont]; ?></option>
                        <option>Todos</option>
                        <option></option>
