...
<td>&nbsp;<?php echo $linha[item] ?>
    ...
    <td colspan="">&nbsp;<?php
                            ...
                            $sql2 = "SELECT * FROM subitens2 WHERE id_item = $linha[id_itens]";
                            ...
                            if (empty($linha2[id_subitem])) 
                                ...
                                while($linha2){
                                    ...
                                    echo "$linha2[qtde_si]-$linha2[nome_subitem] MARCA: $linha2[marca_si] / MODELO: $linha2[modelo_si], ";
    ...
    <td>&nbsp;<?php
                            ...
                            if (empty($linha2[id_subitem]))
                                ...
                                while($linha2){
                                    ...
                                    echo "$linha2[forn_si] - RO: $linha2[ro_si],";
