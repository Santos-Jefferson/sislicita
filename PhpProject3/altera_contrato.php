...
$sql = "SELECT * FROM contrato WHERE id_contrato={$_GET[alterar]}";
//executa a query
$res = mysql_query($sql) or die("Erro selecionando (altera_contrato.php)");
...
$v = split('[/.-]', $linha[data_ass_cont]);

$linha[data_ass_cont] = $v[2].'/'.$v[1].'/'.$v[0];
...
$res_cod_lote = mysql_query($sql_cod_lote) or die("Erro seleção - res_contrato");
       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td colspan="10"><input type="text" name="data_ass_cont" size="8" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $linha[data_ass_cont]; ?>">
                    <?php 
            ...
            <td width="140" align="right">Número do Contrato:</td>
                <td colspan="10"><input type="text" name="num_cont" size="20" maxlength="50" value="<?php echo $linha[num_cont]; ?>">
                    <?php
                        //if($erro_num_cont){
            ...
            <td width="140" align="right">Prazo de Garantia (Meses):</td>
                <td colspan="10" align="left">
                    <select name="prazo_gar" size="0" >
                        <option><?php echo $linha[prazo_gar]; ?></option>
                        <option>3</option>
                        <option>12</option>
                        <option>24</option>
                        <option>36</option>
            ...
            <td width="140" align="right">Modalidade de Garantia:</td>
                <td colspan="10" align="left">
                    <select name="mod_gar" size="0" >
                        <option><?php echo $linha[mod_gar]; ?></option>
            ...
            <tr>
                ...
                <td width="140" align="right">Vale como Empenho?</td>
                    ...
                    <select name="vale_emp" size="0" >
                        <option><?php echo $linha[vale_emp]; ?></option>
                        <option>Sim</option>
                        <option>Não</option>
                    </select>
            ...
            <tr>
                ...
                <td></td>
                <td colspan="3" align="left"><input type="submit" value="Alterar e Enviar Contrato" /></td>
                ...
                <td><input type="hidden" name="id_contrato" value="<?php echo $linha[id_contrato]; ?>">
                </td>
                ...
                if(!$erro and !empty($_POST)){
                    echo '<script language="javascript">document.altera_contrato.submit()</script>';
                }
