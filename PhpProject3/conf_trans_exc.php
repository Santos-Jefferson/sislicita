...
?>
   ...
   <tr>
        <td colspan="2" align="left" bgcolor="red" class="A" scope="col">
            Remover a TRANSPORTADORA <?php echo $_GET[nome_trans]; ?>?
            <input type='button' value='SIM'
               onclick='document.location.href="apaga_trans.php?apagar=<?php echo $_GET[apagar]; ?>"'>
            <input type='button' value='NÃO'
               onclick='document.location.href="lista_cad_transportadora_tudo.php"'>
        </td>
