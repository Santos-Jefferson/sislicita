...
$sql = "SELECT * FROM lote WHERE codigo LIKE '%{$_GET[codigo]}%' ORDER BY {$_GET[order]}";
...
require_once "pes_rapida_cad_exc.php";
?>

<form action="apaga_cad.php">
<?php

require_once "tab_cab_lotes_exc.php"
...
require "tab_cont_lotes_exc.php";
