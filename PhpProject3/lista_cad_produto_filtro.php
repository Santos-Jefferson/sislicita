...
if(empty($_GET[order])) $_GET[order] = 'desc_prod';
//if(empty($_GET[order2])) $_GET[order2] = 'hora';

//if($usuario == "admin"){

    $sql = "SELECT * FROM cad_produto WHERE tipo_prod = '{$_REQUEST[lista_tipo]}'ORDER BY {$_GET[order]} {$_GET[ascdesc]}";
    //}
    //else{
...
<!--<table width="1020" align="center" class="A" border="1" cellpadding="2" cellspacing="0">-->
    ...
    <tr>
        <td colspan="7">
            ...
            <input type='button' value='Entrada/Saída Notas Fiscais'
               onclick='document.location.href="cad_entrada_prod.php"'>
            <input type='button' value='Relatório de Cotação'
        ...
        <tr class="">
            <!--<th>Cod_int</th>-->
            <th align="center">CÓD. MAESTRO</th>
            <th width="100" align="center"><a href="lista_cad_produto_filtro.php?order=tipo_prod&ascdesc=DESC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/cima.png"></a>TIPO<a href="lista_cad_produto_filtro.php?order=tipo_prod&ascdesc=ASC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/baixo.png"></a></th>
            <th width="90" align="center"><a href="lista_cad_produto_filtro.php?order=marca_prod&ascdesc=DESC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/cima.png"></a>MARCA<a href="lista_cad_produto_filtro.php?order=marca_prod&ascdesc=ASC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/baixo.png"></a></th>
            <th colspan="3" width="90" align="center"><a href="lista_cad_produto_filtro.php?order=desc_prod&ascdesc=DESC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/cima.png"></a>MODELO/DESCRIÇÃO<a href="lista_cad_produto_filtro.php?order=desc_prod&ascdesc=ASC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/baixo.png"></a></th>
            <th width="60" align="center"><a href="lista_cad_produto_filtro.php?order=qtde_estoque&ascdesc=DESC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/cima.png"></a>QTDE<a href="lista_cad_produto_filtro.php?order=qtde_estoque&ascdesc=ASC&lista_tipo=<?php echo $_REQUEST[lista_tipo]; ?>"><img src="imagens/baixo.png"></a></th>
