...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "selec_dec_personalizado.php";
                            else echo "gera_declaracoes.php"; ?>" method="POST" name="selec_dec_personalizado">
       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            ...
            <tr>
                <td width="" align="right">Título da Declaração</td>
