...
?>
   ...
   <tr>
        <td colspan="2" align="left" bgcolor="red" class="A" scope="col">
            Remover o fornecedor <?php echo $_GET[nome_forn]; ?>?
            <input type='button' value='SIM'
               onclick='document.location.href="apaga_forn.php?apagar=<?php echo $_GET[apagar]; ?>"'>
            <input type='button' value='NÃO'
               onclick='document.location.href="lista_cad_fornecedor_tudo.php"'>
        </td>
