...
<tr>
    ...
    <form action="<?php if ($erro or empty($_POST)) echo "cad_ne.php";
       ...
       <table width="1020" align="center" border="1" class="A" cellpading="0" cellspacing="0">
        ...
        <table align="center" width="1010" border="0" class="A" cellpading="0" cellspacing="0" >
            <tr>
                <td colspan="10" align="center"><strong>CADASTRE AQUI AS INFORMAÇÕES DE EXPEDIÇÃO/FATURAMENTO<hr></td>
            </tr>
            <tr>
                <td>
                    <?php
                        require "lista_ne.php"
                    ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="250"><input type="text" name="data_rec_ne" size="8" maxlength="8" onkeyup="Formatadata(this,event)" value="<?php echo $_POST[data_rec_ne]; ?>">
                    <?php 
                        if ($erro_data_rec_ne){
                ...
                <td colspan="10" rowspan="6">
                    <?php 
                    //require "lista_itens_ne_exp_tudo.php"
            ...
            <td width="140" align="right">Número da Nota de Empenho:</td>
                <td><input type="text" name="num_ne" size="20" maxlength="20" value="<?php echo $_POST[num_ne]; ?>">
                    <?php
                        //if($erro_num_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
                ...
                <td><input type="text" name="data_prev_pgto" size="4" maxlength="4" value="<?php echo $_POST[data_prev_pgto]; ?>">
                    <?php
                        //if($erro_num_ne){
                          //  echo "<font color=red>*** Campo obrigatório</font>";
                        //}
