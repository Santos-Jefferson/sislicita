...
?>
   ...
   <tr>
        <td colspan="2" align="left" bgcolor="red" class="A" scope="col">
            Remover a certidão <b><?php echo $_GET[nome_cert]; ?>?
            <input type='button' value='SIM'
               onclick='document.location.href="apaga_certidoes.php?apagar=<?php echo $_GET[apagar]; ?>"'>
            <input type='button' value='NÃO'
               onclick='document.location.href="lista_cad_certidoes.php"'>
        </td>
    </tr>
